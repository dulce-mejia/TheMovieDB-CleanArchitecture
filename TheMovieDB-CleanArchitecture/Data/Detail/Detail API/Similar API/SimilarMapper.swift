...
final class SimilarMapper {
    ...
    static func map(_ data: Data, _ response: HTTPURLResponse) -> RemoteSimilarLoader.Result {

        guard response.isOK else {
            return .failure(RemoteSimilarLoader.Error.invalidData)
        }
        do {
